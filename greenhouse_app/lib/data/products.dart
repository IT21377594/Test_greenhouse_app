...
List<Product> products = [
  ...
  const Product(
    ...
    image: 'assets/greenchilies.jpeg',
    price: 8.44,
    unit: 'kg',
    rating: 4.18,
  ),
  const Product(
    name: "Pest and Disease Control Products",
    description:
    ...
    image: 'assets/pest-disease.jpeg',
    price: 14.52,
    unit: 'kg',
    rating: 5.0,
  ),
  const Product(
    name: "Harvesting and Processing Tools",
    description:
  ...
  const Product(
    name: "Chili-based Food Products",
    description:
    ...
    image: 'assets/chili-products.jpeg',
    price: 6.84,
    unit: 'kg',
    rating: 3.22,
  ),
